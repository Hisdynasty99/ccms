...
//   $toal_cases_registered = mysqli_num_rows($result4);
 ?>
                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/civil_registry.php">Civil Registry<span class="badge badge-secondary">New</span></a>
                                        </li>
                                        <!-- <li class="nav-item">
                            ...
                            <!-- <li class="nav-item "> -->
                                <a class="nav-link" href="pages/usermanagement.php"><i class="fab fa-fw fa-wpforms"></i>Manage Users</a>
                    ...
                    <div class="ecommerce-widget">
                        ...
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1"><?php echo $toal_users ?></h1>
                                        </div>
                                        <div class="metric-label d-inline-block float-right text-grey font-weight-bold">
                                        <i class="fas fa-6x fa-users "></i>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1"><?php echo $toal_cases ?></h1>
                                        </div>
                                        <div class="metric-label d-inline-block float-right text-grey font-weight-bold">
                                        <i class="fas fa-6x fa-gavel"></i>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted">Total Cases Registered</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1"><?php echo $toal_cases_registered ?></h1>
                                        </div>
                                        <div class="metric-label d-inline-block float-right text-grey font-weight-bold">
                                        <i class="fas fa-6x fa-gavel"></i>
                                        </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1"><?php echo $toal_clients ?></h1>
                                        </div>
                                        <div class="metric-label d-inline-block float-right text-grey font-weight-bold">
                                        <i class="fas fa-6x fa-users "></i>
                                        </div>
                        ...
                        <div class="row">
                                                ...
                                                <?php   // LOOP TILL END OF DATA
                                                    while($rows4=$result4->fetch_assoc())
                                                       ...
                                                       ?>
                                                        ...
                                                        <td><?php echo $rows4['first_name'];?></td>
                                                       <td><?php echo $rows4['middle_name'];?></td>
                                                       <td><?php echo $rows4['sur_name'];?></td>
                                                      <td><?php echo $rows4['email'];?></td>
                                                     <td><?php echo $rows4['phonenumber'];?></td>
                                                     <td><?php echo $rows4['status'];?></td>
                                                    <td><?php echo $rows4['username'];?></td>
                                                    </tr>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">Cases Registration Progress</h5>
                                    <div class="card-body">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                             Copyright © 2022 Concept. All rights reserved. Dashboard by <a href="https://colorlib.com/wp/">KALASA</a>.
                        </div>
                        <!-- <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
