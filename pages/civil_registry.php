                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="#">Civil Registry<span class="badge badge-secondary">New</span></a>
                                        </li>
                                        <!-- <li class="nav-item">
                            ...
                            <!-- <li class="nav-item "> -->
                            <a class="nav-link" href="usermanagement.php"><i class="fab fa-fw fa-wpforms"></i>Manage Users</a>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title"><b>Civil Registry</b></h2>
                            <p class="pageheader-text"></p>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Dashboard</a></li>
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Case Management</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Civil Registry</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                        ...
                        <table class="table">
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        ...
                                                        <th class="border-0">Filling Date</th>
                                                        <th class="border-0">Case Number</th>
                                                        <th class="border-0">Violated Law</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                <?php   // LOOP TILL END OF DATA
                                                    while($rows=$result->fetch_assoc())
                                                       ...
                                                       <td><?php echo $rows['filling_date'];?></td>
                                                       <td><?php echo $rows['case_number'];?></td>
                                                      <td><?php echo $rows['violated_law'];?></td>
                                                    </tr>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            Copyright © 2022 Concept. All rights reserved. Dashboard by <a href="">KALASA</a>.
                        </div>
                        <!-- <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
